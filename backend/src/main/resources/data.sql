...
INSERT IGNORE INTO proposals (title, description, start_date, end_date, is_active) VALUES 
...
-- Datos de votos de prueba
INSERT IGNORE INTO votes (vote, user_id, proposal_id) VALUES 
('POSITIVE', 1, 1),
('POSITIVE', 2, 1),
('NEGATIVE', 3, 1),
('ABSTENCY', 4, 1),
